...
def generar_html_hero(marca, hero, whatsapp, paleta_key):
...
@app.route("/")
def index():
    return render_template("index.html", paletas=PALETAS)
...
def generar():
    ...
    html_output = generar_html_hero(marca, hero, whatsapp, paleta_key)
